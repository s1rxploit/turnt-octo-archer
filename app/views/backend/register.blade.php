		...
		<div class="login-wrapper">
			...
			<form action="/register" method="POST" role="form">
				<div class="popup-header">
					<a href="#" class="pull-left"><i class="icon-user-plus"></i></a><span class="text-semibold">Register</span>
					<div class="btn-group pull-right">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-cogs"></i></a>
						<ul class="dropdown-menu icons-right dropdown-menu-right">
							<li>
								<a href="/forgot-password"><i class="icon-info"></i> Forgot Password </a>
							</li>
							<li>
								<a href="/login"><i class="icon-user4"></i> Already registered ? Sign in </a>
							</li>
						</ul>
					</div>
				</div>
				<div class="well">
					<div class="form-group has-feedback">
						...
						<i class="icon-user4 form-control-feedback"></i>
					</div>
					<div class="form-group has-feedback">
						<label>Email</label>
