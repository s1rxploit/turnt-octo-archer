...
<div class="login-wrapper">
  ...
  <form action="/customer/register" method="POST" role="form">
    <div class="popup-header"><a href="#" class="pull-left"><i class="icon-user-plus"></i></a><span class="text-semibold">Register</span>
      <div class="btn-group pull-right"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-cogs"></i></a>
        <ul class="dropdown-menu icons-right dropdown-menu-right">
          ...
          <li><a href="/customer/login"><i class="icon-user4"></i> Already registered ? Sign in </a></li>
        </ul>
      </div>
    </div>
    <div class="well">
    <div class="form-group has-feedback">
      ...
      <div class="row form-actions">
              <div class="col-xs-12">
                <a href="/customer/facebook" type="submit" class="btn btn-info btn-block pull-right"><i class="icon-facebook"></i> Register with Facebook</a>
              </div>
