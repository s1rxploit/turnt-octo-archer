...
Route::get('/admin/messages/get_user_thread/{user_id}', 'MessageController@getMessagesByThread');
Route::post('/admin/messages/send_message', 'MessageController@sendMessage');
